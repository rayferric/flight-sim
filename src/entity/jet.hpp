...
protected:
	...
	const float max_thrust_dry = 86000.0f;  // N
	const float max_thrust_wet = 264000.0f; // N
	...
	const glm::vec3 center_of_mass              = {-13.0f, 0.0f, 0.0f};
	const glm::vec3 center_of_thrust            = {-20.0f, 0.0f, 0.0f};
	...
	const float     thrust_incidence_deg        = 3.5f;
